...
11. [Domain Driven Design (DDD)](#domain-driven-design-ddd)  
12. [Entity](#entity)  
13. [Encapsulation](#encapsulation)  
14. [Fluent Api](#fluent-api)  
15. [Forretningsobjekt](#forretningsobjekt)  
16. [ICollection](#icollection)  
17. [Iterative Agile](#iterative-agile)  
18. [JWT](#jwt)  
19. [Klasser](#klasser)  
20. [Models](#models)  
21. [Objekt](#objekt)  
22. [OOP (Objektorienteret programmering)](#oop-objektorienteret-programmering)  
23. [Repository og interface](#repository-og-interface)
24. [Scalar](#scalar)  
25. [Separation of Concerns](#separation-of-concerns)
26. [Services](#services)  
27. [.NET Apps](#net-apps)
